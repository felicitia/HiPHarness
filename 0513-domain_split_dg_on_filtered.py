...
from dg_model import DomainSplitDGModel
...
if __name__ == '__main__':
    ...
    model_build_func = lambda :DomainSplitDGModel(args.dg_window_size,args.dg_weight_threshold)
    for account in reader.accounts():
        r = (dg_test_user(reader,account,model_build_func,args.train_ratio))
        if r:
            print(r)
