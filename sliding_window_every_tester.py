...
def e_test_user(reader, account, model_build_func,sliding_window_size,train_ratio):
...
if __name__ == '__main__':
    ...
    print(e_test_user(URLRecordReader(args.data_dir), args.account,
                       lambda: PrefetchEverythingModel(),args.sliding_window_size,args.train_ratio))
